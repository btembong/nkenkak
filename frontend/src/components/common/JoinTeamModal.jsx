        ...
        <div className="px-7 pt-7 pb-5 border-b" style={{borderColor:'rgba(91,45,142,0.08)'}}>
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm mt-1 text-muted-foreground">Choose your team and start making a difference</p>
            </div>
            <button onClick={onClose}
              className="w-9 h-9 rounded-full flex items-center justify-center transition-colors hover:bg-primary-50 text-muted-foreground">
              <X className="w-4 h-4"/>
            </button>
          </div>
        </div>
        ...
        <div className="p-7">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              {errors.email && <p className="text-xs mt-1 text-red-500">Email required</p>}
            </div>
            <div>
