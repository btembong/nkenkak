...
export default function DonationModal({ onClose, defaultProject = '' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-dark/72 backdrop-blur-[10px]"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="animate-fade-in">
              ...
              <div className="flex items-center gap-3 p-3 rounded-2xl mb-5 bg-primary-50 border border-primary-500/12">
                ...
                <button type="button" onClick={() => setStep(1)}
                  className="text-[10px] font-bold px-3 py-1.5 rounded-full flex-shrink-0 transition-all hover:opacity-80 text-primary-500 bg-primary-500/8">
                  Change
                </button>
              </div>
