...
import { MailOpen, ArrowLeft, Loader2, Send } from 'lucide-react'
          ...
          {done ? (
            <div className="text-center py-4">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5"
                ...
                <MailOpen className="w-7 h-7 text-primary-500"/>
              </div>
              <h2 className="font-display font-bold text-2xl mb-3 text-dark">Check your email</h2>
            ...
            <>
              <h2 className="font-display font-bold text-2xl mb-1 text-dark">Forgot Password?</h2>
              <p className="text-sm mb-7 text-muted-foreground">Enter your email and we'll send a reset link.</p>
